...
-- Lock Database
UPDATE databasechangeloglock SET LOCKED = TRUE, LOCKEDBY = 'IN-MH1LPW101591 (192.168.1.107)', LOCKGRANTED = '2020-06-01 18:25:17.073' WHERE ID = 1 AND LOCKED = FALSE;
