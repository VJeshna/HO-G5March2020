...
public class AOPDemo {
	...
	@Before("execution(* com.mastek.app.service.CustomerService.*(..))")
	...
	@After("execution(* com.mastek.app.service.CustomerService.*(..))")
	...
	@AfterReturning(pointcut = "execution(* com.mastek.app.service.CustomerService.*(..)))", returning = "result")
	...
	@AfterThrowing(pointcut = "execution(* com.mastek.app.service.CustomerService.*(..)))", throwing = "error")
	...
	@Around("execution(* com.mastek.app.service.CustomerService.*(..)))")
